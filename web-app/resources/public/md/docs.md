...
Two middleware functions are provided by default in the `movie-advisor.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `movie-advisor.handler` namespace to manage the enabled middleware.
